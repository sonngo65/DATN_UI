...
export default function SideBar() {
  return (
    <aside className="main-sidebar sidebar-dark-primary elevation-4 px-2">
      {/* <!-- Brand Logo --> */}
      <a
        href="index3.html"
        className="brand-link user-panel d-flex justify-content-start align-items-center px-3 py-3"
      >
        <span className="brand-text font-weight-light d-block">Admin</span>
      </a>
        ...
        <nav className="mt-2">
          ...
          >
            ...
            <li className="nav-item">
              <a href="#" className="nav-link px-3 py-3 active">
                <MdOutlineSpaceDashboard />
                <p className="d-inline-block m-0 ps-2">Dashboard</p>
              </a>
            </li>
            <li className="nav-item">
              <a href="pages/widgets.html" className="nav-link px-3 py-3">
                <LuShoppingBag />
                <p className="d-inline-block m-0 ps-2">
                  Product
